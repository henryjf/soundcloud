...
form.on('submit', function (event) {
  ...
  _jquery2['default'].getJSON(url + 'tracks/?client_id=' + token + '&limit=15&q=' + searchTerm).then(function (response) {
  ...
  albums.on('click', '.artwork', function (event) {
    ...
    var song = (0, _jquery2['default'])(this).find('.stream_url').text() + '?client_id=' + token + "&limit=15&q=";
